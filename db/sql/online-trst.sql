...
INSERT INTO "diagnostics" VALUES(1, 'TREM01', 0.3, 'EM', 0, 459, 'diagnostics');
INSERT INTO "diagnostics" VALUES(2, 'TRHP06', 6.8, 'HP', 0, 467, 'diagnostics');
INSERT INTO "diagnostics" VALUES(3, 'TRHP07', 15.0, 'HP', 0, 482, 'diagnostics');
INSERT INTO "diagnostics" VALUES(4, 'TRHP08', 23.2, 'HP', 0, 496, 'diagnostics');
INSERT INTO "diagnostics" VALUES(5, 'TRSM05', 3.0, '', 0, 463, 'diagnostics');
INSERT INTO "diagnostics" VALUES(6, 'TRSM06', 5.0, '', 0, 465, 'diagnostics');
INSERT INTO "diagnostics" VALUES(7, 'TRSM07', 25.0, '', 0, 498, 'diagnostics');
INSERT INTO "diagnostics" VALUES(8, 'TRSM08', 27.0, '', 0, 500, 'diagnostics');
INSERT INTO "diagnostics" VALUES(9, 'TREM02', 31.0, 'EM', 0, 504, 'diagnostics');
CREATE TABLE drift(
  id integer primary key,
  name text unique,
  view_index double precision unique,
...
INSERT INTO "drift" VALUES(1, 'TRDR01', 0.0, 0.1751, 0.0254, 0.0, '', '', 458, 'drift');
INSERT INTO "drift" VALUES(2, 'TRDR02', 0.5, 0.0575, 0.0254, 0.0, '', '', 460, 'drift');
INSERT INTO "drift" VALUES(3, 'TRDR03', 2.0, 0.1952, 0.0254, 0.0, '', '', 462, 'drift');
INSERT INTO "drift" VALUES(4, 'TRDR04', 4.0, 0.141, 0.0254, 0.0, '', '', 464, 'drift');
INSERT INTO "drift" VALUES(5, 'TRDR05', 6.0, 0.1321, 0.0254, 0.0, '', '', 466, 'drift');
INSERT INTO "drift" VALUES(6, 'TRDR06', 8.0, 0.0737, 0.0254, 0.0, '', '', 469, 'drift');
INSERT INTO "drift" VALUES(7, 'TRDR07', 10.0, 0.087, 0.0254, 0.0, '', '', 471, 'drift');
INSERT INTO "drift" VALUES(8, 'TRDR08', 12.0, 0.0437705652838511, 0.0254, 0.04137722, 1, 2, 476, 'drift');
INSERT INTO "drift" VALUES(9, 'TRDR09', 14.0, 0.05, 0.0254, 0.0, '', '', 481, 'drift');
INSERT INTO "drift" VALUES(10, 'TRDR10', 16.0, 0.05, 0.0254, 0.0, '', '', 483, 'drift');
INSERT INTO "drift" VALUES(11, 'TRDR11', 18.0, 0.0437705652838511, 0.0254, 0.04137722, 1, 2, 488, 'drift');
INSERT INTO "drift" VALUES(12, 'TRDR12', 20.0, 0.09, 0.0254, 0.0, '', '', 492, 'drift');
INSERT INTO "drift" VALUES(13, 'TRDR13', 22.0, 0.0737, 0.0254, 0.0, '', '', 494, 'drift');
INSERT INTO "drift" VALUES(14, 'TRDR14', 24.0, 0.1291, 0.0254, 0.0, '', '', 497, 'drift');
INSERT INTO "drift" VALUES(15, 'TRDR15', 26.0, 0.141, 0.0254, 0.0, '', '', 499, 'drift');
INSERT INTO "drift" VALUES(16, 'TRDR16', 28.0, 0.1952, 0.0254, 0.0, '', '', 501, 'drift');
INSERT INTO "drift" VALUES(17, 'TRDR17', 30.0, 0.0575, 0.0254, 0.0, '', '', 503, 'drift');
INSERT INTO "drift" VALUES(18, 'TRDR18', 32.0, 0.1284, 0.0254, 0.0, '', '', 505, 'drift');
CREATE TABLE dipole(
  id integer primary key,
  name text unique,
  view_index double precision unique,
...
INSERT INTO "dipole" VALUES(1, 'TRBM01', 1.0, 1.32155958887372, 0.349065850398866, 0.02853, 0.0, 0.349065850398866, -0.424, 0.002, -0.204, 100.0, 1.0, 44.094, NULL, 100.0, 939.272, 1, '', 461, 'dipole');
INSERT INTO "dipole" VALUES(2, 'TRBM05', 11.0, 28.46743942931, 0.016845943445215, 0.02853, 0.349065850398866, -0.332219906953651, -0.424, 0.002, -0.204, 100.0, 1.0, 44.094, 0.9071529006214, 100.0, 939.272, 1, 2, 473, 'dipole');
INSERT INTO "dipole" VALUES(3, 'TRBM06', 13.0, 1.38589788835821, 0.332219906953651, 0.02853, 0.332219906953651, 0.0, -0.424, 0.002, -0.204, 100.0, 1.0, 44.094, 0.9071529006214, 100.0, 939.272, 1, 2, 478, 'dipole');
INSERT INTO "dipole" VALUES(4, 'TRBM07', 17.0, 1.38589788835821, 0.332219906953651, 0.02853, 0.0, 0.332219906953651, -0.424, 0.002, -0.204, 100.0, 1.0, 44.094, 0.9071529006214, 100.0, 939.272, 1, 2, 485, 'dipole');
INSERT INTO "dipole" VALUES(5, 'TRBM08', 19.0, 28.46743942931, 0.016845943445215, 0.02853, -0.332219906953651, 0.349065850398866, -0.424, 0.002, -0.204, 100.0, 1.0, 44.094, 0.9071529006214, 100.0, 939.272, 1, 2, 490, 'dipole');
INSERT INTO "dipole" VALUES(6, 'TRBM04', 29.0, 1.32155958887372, 0.349065850398866, 0.02853, 0.349065850398866, 0.0, -0.424, 0.002, -0.204, 100.0, 1.0, 44.094, NULL, 100.0, 939.272, 1, '', 502, 'dipole');
CREATE TABLE quad(
  id integer primary key,
  name text unique,
  view_index double precision unique,
...
INSERT INTO "quad" VALUES(1, 'TRQM05', 7.0, 0, 16.341, 0.12, 0.0, 1, 0.0, 1, 3, 468, 'quad');
INSERT INTO "quad" VALUES(2, 'TRQM06', 9.0, 0, -12.689, 0.12, 0.0, 2, 0.0, -1, 4, 470, 'quad');
INSERT INTO "quad" VALUES(3, 'TRQM07', 21.0, 0, -19.648, 0.12, 0.0, 3, 0.0, -1, 5, 493, 'quad');
INSERT INTO "quad" VALUES(4, 'TRQM08', 23.0, 0, 20.7282, 0.12, 0.0, 4, 0.0, 1, 6, 495, 'quad');
...
INSERT INTO "rotation" VALUES(1, 'TRBM05-BEFORE', 10.5, 3.14159265358979, 472, 'rotation');
INSERT INTO "rotation" VALUES(2, 'TRBM05-AFTER', 11.5, 3.14159265358979, 474, 'rotation');
INSERT INTO "rotation" VALUES(3, 'TRBM06-BEFORE', 12.5, 3.14159265358979, 477, 'rotation');
INSERT INTO "rotation" VALUES(4, 'TRBM06-AFTER', 13.5, 3.14159265358979, 479, 'rotation');
INSERT INTO "rotation" VALUES(5, 'TRBM07-BEFORE', 16.5, 3.14159265358979, 484, 'rotation');
INSERT INTO "rotation" VALUES(6, 'TRBM07-AFTER', 17.5, 3.14159265358979, 486, 'rotation');
INSERT INTO "rotation" VALUES(7, 'TRBM08-BEFORE', 18.5, 3.14159265358979, 489, 'rotation');
INSERT INTO "rotation" VALUES(8, 'TRBM08-AFTER', 19.5, 3.14159265358979, 491, 'rotation');
...
INSERT INTO "raperture" VALUES(1, 'TRBM05-APER', 11.75, 0.0696488118594079, 0.0343611881405921, 0.0261493, 0.0261493, 0.140891188140592, 1, 1, 2, 475, 'raperture');
INSERT INTO "raperture" VALUES(2, 'TRBM06-APER', 13.75, 0.113365177348903, 0.0484748226510966, 0.0261493, 0.0261493, 0.0508348226510966, 1, 1, 2, 480, 'raperture');
INSERT INTO "raperture" VALUES(3, 'TRBM07-APER', 17.75, 0.0696488118594079, 0.0343611881405921, 0.0261493, 0.0261493, 0.140891188140592, 1, 1, 2, 487, 'raperture');
