...
initv = hps.get_db_epics("01JS001D01")
print "Init value of 01JS001D01 is ", initv
print "Init rfgap.amplitude_model is ", hps.get_db_model("01RG01", "amplitude_model")
hps.set_db_epics("01JS001D01", 40)
print "Now value of 01JS001D01 is ", hps.get_db_epics("01JS001D01") 
print "Now rfgap.amplitude_model is ", hps.get_db_model("01RG01", "amplitude_model")
hps.set_db_epics("01JS001D01", initv)
print "After reset, value of 01JS001D01 is ", hps.get_db_epics("01JS001D01")
