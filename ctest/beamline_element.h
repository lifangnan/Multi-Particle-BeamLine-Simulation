...
private:
  ...
  //! Name of the element
  std::string name_;
  //! Length of the element (in meter)
  double length_;
  //! Aperture of the element (in meter)
  double aperture_;
  //! If monitor is on, output beam properties in the middle of the element
  bool monitor_on_;
};
...
public:
  ...
  void Print() const;
private:
  //! Indicate if the aperture is applied or not
  bool isin_;
};
...
private:
  //! Indicate if the aperture is applied or not
  bool isin_;
  //! Horizontal aperture from the left to the center of the beam (in meter)
  double aperture_x_left_;
  //! Horizontal aperture from the right to the center of the beam (in meter)
  double aperture_x_right_;
  //! Vertical aperture from the top to the center of the beam (in meter)
  double aperture_y_left_;
  //! Vertical aperture from the bottom to the center of the beam (in meter)
...
public:
  ...
  void Accept(Visitor*); 
private:
  //! Indicate if the buncher is turned on
  bool ison_;
  //! Voltage of the buncher (in MV)
  double voltage_;
  //! Frequency of the buncher (in MHz)
  double frequency_;
  //! Phase of the buncher (in radian)
  double phase_;
};
...
public:
  ...
  void Accept(Visitor*);
private:
  //! Host pointer to dipole parameter
  DipoleParameter* param_h_;
  //! Device pointer to dipole parameter
...
public:
  ...
  void Accept(Visitor*);
private:
  //! Host pointer to RFGap parameter
  RFGapParameter* param_h_;
  //! Device pointer RFGap parameter
...
public:
  ...
  void Print() const;
private:
  //! 1 means no compensation, 0 means fully compensated.
  double fraction_;
};
...
public:
  ...
  void Print() const;
private:
  //! Horizontal strength, B * length
  double bl_h_;
  //! Vertical strength, B * length
  double bl_v_; 
};
...
/*!
 * \brief If monitor is turned on, output at the middle of the element.
 *
 * Online mode.
 */
inline 
...
/*!
 * \brief Check if the aperture is applied.
 */
inline
...
/*!
 * \brief Apperture from the beam center
 */
inline
...
/*!
 * \brief Get the host pointer to parameters
 */
inline
...
/*!
 * \brief Get the device pointer to parameters
 */
inline
